...
class Ui_dlgStartSim(object):
    def setupUi(self, dlgStartSim):
        ...
        self.gridSim.addWidget(self.lblAutoPlot, 3, 1, 1, 1)
        ...
        self.gridSim.addWidget(self.cbxAutoPlotters, 3, 2, 1, 1)
    ...
    def retranslateUi(self, dlgStartSim):
        ...
        self.lblMpi.setText(_translate("dlgStartSim", "MPI:"))
        ...
        self.cbxClustering.setItemText(0, _translate("dlgStartSim", "No clustering"))
        self.cbxClustering.setItemText(1, _translate("dlgStartSim", "MPI clustering"))
        self.cbxClustering.setItemText(2, _translate("dlgStartSim", "MPI clustering (recompile)"))
...
class Ui_dlgConfig(object):
    def setupUi(self, dlgConfig):
        ...
        self.lblInfocol = QtWidgets.QLabel(dlgConfig)
        self.lblInfocol.setObjectName("lblInfocol")
        self.gridFlags.addWidget(self.lblInfocol, 14, 0, 1, 1)
        self.edtInfoCol = QtWidgets.QLineEdit(dlgConfig)
        self.edtInfoCol.setObjectName("edtInfoCol")
        self.gridFlags.addWidget(self.edtInfoCol, 15, 0, 1, 1)
        self.lblErrcol = QtWidgets.QLabel(dlgConfig)
        self.lblErrcol.setObjectName("lblErrcol")
        self.gridFlags.addWidget(self.lblErrcol, 16, 0, 1, 1)
        self.edtErrCol = QtWidgets.QLineEdit(dlgConfig)
        self.edtErrCol.setObjectName("edtErrCol")
        self.gridFlags.addWidget(self.edtErrCol, 17, 0, 1, 1)        
    ...
    def retranslateUi(self, dlgConfig):
        ...
        self.lblInfocol.setText(_translate("dlgConfig", "Info color in terminal output"))
        self.lblErrcol.setText(_translate("dlgConfig", "Error color in terminal output"))
